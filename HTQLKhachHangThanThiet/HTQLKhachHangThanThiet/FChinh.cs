...
namespace HTQLKhachHangThanThiet
{
    public partial class FChinh : Form
    {
        ...
        private void setNhanVien()
        {
            ...
            qLyDanhMucToolStripMenuItem.Enabled = false;
            qLyKhachHangToolStripMenuItem.Enabled = true;
            qLyDonHangToolStripMenuItem.Enabled = true;
            qLySanPhamToolStripMenuItem.Enabled = false;
            quảnLýHạngThànhViênToolStripMenuItem.Enabled = true;
            qLyNhanVienToolStripMenuItem.Enabled = false;
        }
        private void setAdmin()
        {
            ...
            TrangChuToolStripMenuItem1.Enabled = true;
            qLThongTinToolStripMenuItem.Enabled = true;
            qLyDanhMucToolStripMenuItem.Enabled = true;
            qLyKhachHangToolStripMenuItem.Enabled = true;
            qLyDonHangToolStripMenuItem.Enabled = true;
            qLySanPhamToolStripMenuItem.Enabled = true;
            quảnLýHạngThànhViênToolStripMenuItem.Enabled = true;
            qLyNhanVienToolStripMenuItem.Enabled = true;
        ...
        {
            OpenChildForm(new F_QLDanhMuc(string.IsNullOrEmpty(dn.MaNV)));
        }

        private void qLySanPhamToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenChildForm(new F_QLSanPham(string.IsNullOrEmpty(dn.MaNV)));
        }

        private void qLyKhachHangToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenChildForm(new F_QLKhachHang(string.IsNullOrEmpty(dn.MaNV)));
        }
        ...
        {
            OpenChildForm(new F_QLHang(string.IsNullOrEmpty(dn.MaNV)));
        }
    }
}
